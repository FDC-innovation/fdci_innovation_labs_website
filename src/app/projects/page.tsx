...
import { projects as rawProjects } from "@/data/site-config";
...
import { ExternalLink, Rocket, TrendingUp, CheckCircle2, Code } from "lucide-react";
            ...
            <section className="container-custom">
                <div className="grid md:grid-cols-2 gap-8">
                    {projects.map((project, index) => {
                        ...
                        const hasPics = project.images && project.images.length > 0;

                        return (
                            <motion.div
                                key={index}
                                className={hasPics ? "md:col-span-2" : ""}
                            ...
                            >
                                <Card className="glass-strong h-full group hover:glow-blue transition-all duration-300 border-2 border-transparent hover:border-[#4A90E2]/30 overflow-hidden">
                                    ...
                                    {/* Image gallery — Chalchitra only */}
                                    {hasPics && project.images && (
                                        <div className="relative z-10 p-8 pb-0">
                                            <div className="flex gap-3 h-72 rounded-2xl overflow-hidden">
                                                {/* Large hero image */}
