...
import { Target, Eye, Heart, Users, Award, Rocket, Briefcase, Code, Cloud, Palette, Database, Calculator } from "lucide-react";
...
const values = [
    {
        ...
        description: "We believe in nurturing talent from every corner of India, especially from underserved regions.",
    },
    {
        icon: Award,
        title: "Excellence",
                    ...
                    >
                        ...
                        <div className="space-y-4 text-foreground/90">
                            ...
                            <p>
                                ...
                                technologies, talented students in smaller cities were struggling to access
                                quality tech education and real-world opportunities.
                            </p>
                            <p>
                                Today, we're proud to be Uttarakhand's first AI-focused innovation community,
                                bridging the gap between local talent and global opportunities. We don't just
                                build software—we build futures.
                            </p>
                        </div>
                    </motion.div>
                                ...
                                <CardContent className="p-0">
                                    <div className="relative overflow-hidden">
                                        ...
                                        >
                                                    ...
                                                    />
                                            <div className={`absolute inset-0 bg-gradient-to-t ${member.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300`} />
                                        </motion.div>
                                        <div className="p-6">
                    ...
                    {[
                        {
                            ...
                            image: "/team/aditya-technical-director.png",
                            icon: Code,
                            gradient: "from-[#4A90E2] via-[#5BA0E8] to-[#7DB8F5]",
                            hasImage: true,
                            description: "Expert in building seamless AI and web solutions. Leads our technical vision with a focus on innovative, scalable architectures that bridge cutting-edge AI with modern web technologies.",
                        },
                        {
                            name: "Sunil Butola",
                            ...
                            gradient: "from-[#7DB8F5] via-[#4A90E2] to-[#5BA0E8]",
                            hasImage: true,
                            description: "Specializes in AWS infrastructure and DevOps automation. Ensures our systems are scalable, secure, and always available with 99.9% uptime.",
                        },
                        {
                            name: "Shivam Shahni",
                            ...
                            gradient: "from-[#5BA0E8] via-[#7DB8F5] to-[#4A90E2]",
                            hasImage: false,
                            description: "Builds robust backend systems and APIs. Expert in database design and server-side architecture, ensuring fast and reliable performance.",
                        },
                        {
                            name: "Ayush Hemdam",
                            ...
                            gradient: "from-[#4A90E2] via-[#5BA0E8] to-[#7DB8F5]",
                            hasImage: false,
                            description: "Creates beautiful, user-friendly interfaces and develops efficient algorithms. Combines design thinking with technical expertise to deliver exceptional user experiences.",
                        },
                        {
                            name: "Mujeeb",
                            role: "Accounting & Management",
                            image: "/team/mujeeb-accounting.jpeg",
                            icon: Calculator,
                            gradient: "from-[#7DB8F5] via-[#4A90E2] to-[#5BA0E8]",
                            hasImage: true,
                            description: "Manages our financial operations and administrative processes. Ensures smooth business operations and strategic financial planning.",
                        },
                    ].map((member, index) => {
                                    ...
                                    <CardContent className="p-0">
                                        <div className="relative overflow-hidden">
                                            {member.hasImage ? (
                                                ...
                                                >
                                                    <TeamImage
                                                        ...
                                                        gradient={member.gradient}
                                                    />
                                                    <div className={`absolute inset-0 bg-gradient-to-t ${member.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300 pointer-events-none`} />
                                                </motion.div>
                                            ) : (
                                                <motion.div
                                                    whileHover={{ scale: 1.05 }}
                                            ...
                                            <div className="p-6">
                                                <div className="flex items-center space-x-3 mb-3">
                                                    {!member.hasImage && (
                                                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${member.gradient} flex items-center justify-center shadow-lg`}>
            ...
            <section className="container-custom">
                ...
                >
                    ...
                    <p className="text-foreground/90">
                        FDC Innovation Labs is a proud initiative of Fast Data Connect, a {siteConfig.companyType}{" "}
                        company based in {siteConfig.location}. With the backing of our parent company's
                        expertise and resources, we're able to deliver enterprise-grade solutions while
                        maintaining our focus on community empowerment and student success.
                    </p>
                </motion.div>
            </section>
        </div>
